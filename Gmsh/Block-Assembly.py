...
def main():
    ...
    for PMMA_thickness in PMMA_THICKNESSES:
        ...
        gmsh.model.setPhysicalName(2, blk1["faces_phys"]["stationary-block-back"],  "friction_master")
        gmsh.model.setPhysicalName(2, blk2["faces_phys"]["moving-block-front"], "friction_slave")


        slave_pg  = gmsh.model.addPhysicalGroup(2, [blk1["faces_geo"]["stationary-block-back"]])
        master_pg = gmsh.model.addPhysicalGroup(2, [blk2["faces_geo"]["moving-block-front"]])
